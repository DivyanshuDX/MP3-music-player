...
os.chdir(r"C:\Users\dxarm\Downloads\music for task 3")
songs=os.listdir()
for s in songs:
    playlist.insert(END,s)
heading=tkinter.StringVar();
heading.set("Select the song you want to listen!")
music=PhotoImage(file=r"C:\Users\dxarm\Downloads\music for task 3\download.png")
play_lab=Label(image=music)
musicbtn=Button(root,image=music,command=music)
musicbtn.config(padx=27,pady=3)
musicbtn.grid(row=0,column=1)
click_play=PhotoImage(file=r"C:\Users\dxarm\Downloads\music for task 3\download.png")
...
click_pause=PhotoImage(file=r"C:\Users\dxarm\Downloads\music for task 3\download.png")
...
click_stop=PhotoImage(file=r"C:\Users\dxarm\Downloads\music for task 3\download.png")
...
click_resume=PhotoImage(file=r"C:\Users\dxarm\Downloads\music for task 3\download.png")
